...
class Player {
  ...
  _resolveY() {
    for (const p of lPlatforms) {
      ...
      if (this.vy >= 0) {
        this.y        = p.y - this.h;
        if (this.vy > 4) { this.sqX = 1.42; this.sqY = 0.60; }  // landing squash
        this.vy       = 0;
        this.onGround = true;
        this.jumps    = 0;
        this.coyoteT  = 0;
